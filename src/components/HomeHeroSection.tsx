...
const HomeHeroSection = () => {
  ...
  if (loading) {
    return (
      <section className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center animate-pulse space-y-6 md:space-y-0 px-6 lg:px-8">
  ...
  return (
    <section className="bg-gray-100 py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 lg:px-8 space-y-8 md:space-y-0 md:space-x-10">
        <div className="text-section md:w-1/2">
          <p className="text-sm text-gray-600">{category.data.attributes.name}</p>
          ...
          <p className="text-lg text-gray-700 mb-6">{description.slice(0, 200) + "..."}</p>
          <a
            href={`/post/${article.id}`}
            className="inline-block mt-4 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition"
          >
            Leia mais
          </a>
        </div>
